package com.shekhawat.api_gateway.routes;
...
public class Routes {
    ...
    public RouterFunction<ServerResponse> productServiceSwaggerRoute() {
        return route("product_service_swagger")
                ...
                .filter(setPath("/api-docs"))       // redirect: http://localhost:8080/aggregate/product-service/v3/api-docs -> http://localhost:8080/api-docs
                .build();
    }
    ...
    // whenever service is failing, it will be redirected to this route
    @Bean
